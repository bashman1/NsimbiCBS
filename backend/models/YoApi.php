...
class YoAPI
{
     ...
     * @return string 
     */
    private function Server_connection_error()
    {
        return array('Status' => "ERROR", 'StatusCode' => "--", 'StatusMessage' => "Cannot connect to Mobile Money Services. Please check you network and try again");
    }
    ...
    public function ac_deposit_funds($msisdn, $amount, $narrative)
    {
        ...
        if (!$xml_response) {
            $result = $this->Server_connection_error();
        } else {
