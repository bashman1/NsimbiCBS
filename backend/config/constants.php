...
$semi_production_host = "staging.cbs.io";
$dev_production_host = "dev.cbs.io";
// $local_host = "cbsio.test";
...
if (str_contains($host, 'test') || str_contains($host, 'heroku')) {
    $is_test_environment = true;
    $is_production_environment = false;
}

defined("HOST")                       or define("HOST", $host);
defined("IS_TEST_ENVIRONMENT")                       or define("IS_TEST_ENVIRONMENT", $is_test_environment);
defined("IS_PRODUCTION_ENVIRONMENT")                       or define("IS_PRODUCTION_ENVIRONMENT", $is_production_environment);
