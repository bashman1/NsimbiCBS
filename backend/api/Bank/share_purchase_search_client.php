...
if ($itemCount > 0) {
    ...
    foreach ($stmt as $r) {
        ...
        $return_string .= "<tr><td><img class='rounded-circle' width='30'
             ...
             <td> Shares: " . @$r['no_shares'] . "  |  Share Amount:  ".@$r['share_amount']."</td>
             <td>" . $r['bname'] . "</td>";

        $return_string .= '<td class="text-center no_print"><a class="btn btn-sm btn-primary load_supplement_ajax" href="share_purchase.php?t=' . $r['userId'] . '"> Purchase Shares  </a></td></tr>';
