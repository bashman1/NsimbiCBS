...
if ($itemCount > 0) {
    ...
    foreach ($stmt as $r) {
        ...
        $return_string .= '<td class="text-center no_print"><a class="btn btn-sm btn-primary load_supplement_ajax" href="register_bulk_transfer.php?t=' . encrypt_data($r['userId']) . '">Register Bulk Transfer</a></td></tr>';
