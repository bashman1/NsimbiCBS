...
if ($itemCount > 0) {
    ...
    foreach ($stmt as $r) {
        ...
        $return_string .= '<td class="text-center no_print"><a class="btn btn-sm btn-primary load_supplement_ajax" href="freeze_account.php?t=' . encrypt_data($r['userId']) . '"> Freeze Account Balance  </a></td></tr>';
