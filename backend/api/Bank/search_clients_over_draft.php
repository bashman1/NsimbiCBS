...
if ($itemCount > 0) {
    ...
    foreach ($stmt as $r) {
        ...
        $return_string .= '<td class="text-center no_print"><a class="btn btn-sm btn-primary load_supplement_ajax" href="create_overdraft.php?id=' . encrypt_data($r['userId']) . '">Apply</a></td></tr>';
