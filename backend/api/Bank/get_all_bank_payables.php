...
if ($_GET['bank'] != '') {
    $item->id = $_GET['bank'];
    $stmt = $item->getAllBankCreditors();
}
if ($_GET['branch'] != '') {
    $item->id = $_GET['branch'];
    $stmt = $item->getAllBranchCreditors();
}
            ...
            "actions" => '
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <a class="dropdown-item"
                        href="register_payable.php?id=' . $cred_id . '">Register Payable</a>
                          
                    <a class="dropdown-item text-warning"
                        href="creditor_ledger.php?id=' . $cred_id . '">View Ledger</a>
