<?php
    ...
    if($_GET['bank']==''){
        $stmt = $item->getAllBranchDeposits();
    }else{
        $stmt = $item->getAllBankDeposits();
    }
    ...
    if($itemCount > 0)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
            ...
            $u = array(
                ...
                "acno" => $membership_no,
                "print" => ' <button class="btn btn-success btn-sm edit btn-flat"> <a target="_blank" href="receipt.php?id=' . $tid . '&type=D" style="color:#fff !important;">Print</a></button>',
                ...
                "actions" => ' <div class="d-flex">
                    ...
                    <a href="edit_deposit.php?id='.$tid.'" class="btn btn-primary shadow btn-xs sharp me-1"><i
