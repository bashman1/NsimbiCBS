...
if ($_GET['branch'] != '') {
    ...
    $stmt = $item->getBranchStaffShortfalls();
} else {
    $item->branchId = $_GET['bank'];
    $stmt = $item->getBankStaffShortfalls();
}
...
if ($itemCount > 0) {
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        if ($status == 2) {
            ...
            $btn = '<span class="badge badge-rounded badge-warning">partially paid</span>';
        }
        $u = array(
            "id" => $staff_id,
            "notes" => $narration,
                ...
                <div class="dropdown custom-dropdown mb-0">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item text-primary"
                                                href="clear_shortfall.php?id=' . $ss_id . '"> <i class="fa fa-edit"></i>Clear Shortfall </a>
                                                <a class="dropdown-item text-danger"
                                                href="delete_entry.php?id=' . $ss_id . '"> <i class="fa fa-trash"></i>Delete Entry </a>
    ...
    $userArr['message'] = "No Shortfalls found !";
    http_response_code(200);
    echo json_encode($userArr);
}
