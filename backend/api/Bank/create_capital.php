<?php
    ...
    if($item->createCapital())
    {
        ...
        $userArr["data"] = array();
         ...
         $userArr['message']="Capital not created !";
        http_response_code(200);
        echo json_encode($userArr);
