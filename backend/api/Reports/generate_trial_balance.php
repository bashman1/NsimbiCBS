...
try {
    ...
    $response['assets'] = $assets_account->getAccounts();
    ...
    $response['liabilities'] = $liability_account->getAccounts();
    $i = 0;
    ...
    $response['capital'] = $capital_account->getAccounts();
    $i = 0;
    ...
    $response['suspenses'] = $suspense_account->getAccounts();
    $i = 0;
