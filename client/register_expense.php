...
if (isset($_POST['submit'])) {
    $cash_acc = $_POST['cash_acc'] ?? 0;
    $account_id = $_POST['account_id'] ?? 0;
    $_POST['bank_acc'] = $_POST['bank_acc'] ?? 0;
    $res = $response->createExpense($_POST['heading'], $_POST['amount'], $_POST['main_acc'], $_POST['pay_method'], $_POST['bank_acc'], $cash_acc, $account_id, $_POST['cheque_no'], $_POST['date_of_p'], $_POST['comment'], $user[0]['bankId'], $_POST['branch'], $user[0]['userId']);
    if ($res) {
        setSessionMessage(true, 'Expense Registered Successfully!');
        header('location:accounting_tab.php');
    } else {
        setSessionMessage(false, 'Something went wrong! Try again.');
        header('location:register_expense.php');
    }
    exit;
}
$title = 'EXPENSE ENTRY';
                            ...
                            ';
                                        ...
                                        <select name="main_acc" class="form-control select2" id="journalacc">
                                            ...
                                            if ($sub_accs) {
                                                ...
                                                foreach ($sub_accs as $acc) {
                                                    if ($acc['type'] == 'EXPENSES' && $acc['is_main_account']==0) {
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group" id="offset_savings" style="display: none;">
                                        ...
                                        <select id="clientsselect" class="form-control select2x" name="account_id"> </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label>Voucher No. <i>optional</i>: </label>
