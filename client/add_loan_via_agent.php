            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    mySuccess();
                            ...
                            <input type="hidden" name="branch" value="' . $_REQUEST['branch'] . '" class="form-control" >
                                                    ...
                                                    <div class="col-lg-6 mb-2">
                                                        <div class="mb-3">
                                                            ...
                                                            <select id="single-select2" data-select2-id="single-select2" tabindex="-1" class="select2-hidden-accessible loan-product" aria-hidden="true" name="product" required>
                                                                <option value=""></option>
                                                                <?php
                                                                $lps = $response->getAllBankLoanProducts('', @$_REQUEST['branch']);
                                                                foreach ($lps as $row) {
                                                                    echo '
        ...
        <script>
            ...
            $(document).ready(function() {
                $("select.select2x").select2({
                    ajax: {
                        url: "<?php echo BACKEND_BASE_URL ?>User/get_all_bank_clients_search.php?bank=<?= '' ?>&branch=<?= @$_REQUEST['branch'] ?>",
                        dataType: 'json',
                        data: (params) => {
                            return {
                                q: params.term,
