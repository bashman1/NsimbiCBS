...
if (isset($_GET['did'])) {
    ...
    header('location: institution_client_profile_page?id=' . encrypt_data($_GET['did']));
    exit;
}
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="me-sm-2 default-select form-control wide activate-sections" name="business_type" required>
                                                                ...
                                                                <?php foreach (business_types() as $key => $business_type) { ?>
                                                                    <option value="<?= $key ?>" data-sections="business-type-other" data-activate="0" <?= $member['business_type'] == $key ? 'selected' : '' ?>>
                                                                        <?= $business_type ?>
                                                                    </option>
                                                                <?php } ?>
                                                                <option value="other" <?= $member['business_type'] == 'other' ? 'selected' : '' ?> data-sections="business-type-other" data-activate="1">Other</option>
                                                            </select>
                                                        </div>
                                                    </div>

                                                    <div class="col-lg-6 mb-2 section-business-type-other <?= $member['business_type'] == 'other' ? '' : 'hide' ?>">
                                                        <div class="mb-3">
                                                            <label class="text-label form-label">Business Type Other</label>
                                                            <input type="text" name="business_type_other" class="form-control" data-is-required="1" placeholder="" <?= ($permissions->hasSubPermissions('update_client')) ? '' : 'readonly' ?>>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6 mb-2">
                                                        <div class="mb-3">
                                                            <label class="text-label form-label">Business Registration
                                                                Number #</label>
                                                            <input type="text" name="businessreg" class="form-control" value="<?= $member["registrationNumber"] ?>" placeholder="" <?= ($permissions->hasSubPermissions('update_client')) ? '' : 'readonly' ?>>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 mb-2 mt-3">
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea name="business_nature_description" class="form-control" rows="20"><?= $member["business_nature_description"] ?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 mb-2 mt-3">
                                                        <div class="mb-3">
                                    ...
                                    <form method="POST" enctype="multipart/form-data" action="https://eaoug.org/group_profile_page.php">
                                        ...
                                        <div class="row ">
                                            <div class="col-lg-12 mb-3">
                                                <div class="mb-3">
                                                    <label class="text-label form-label">Institution Photo or Logo</label>
                                            ...
                                            <div class="col-lg-12 mb-3">
                                                <div class="mb-3">
                                                    <label class="text-label form-label">Institution Signatories</label>
                    ...
                    <div class="modal-body">
                        <form action="<?= BACKEND_BASE_URL ?>Accounting/account_balance_reconciliation.php" class="custom-form" id="account_balance_reconciliation" data-reload-page="1" data-confirm-action="1">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <label for="acc_balance">Account Balance: <b><?= number_format(@$member['balance'] ?? 0); ?></b></label>
                                    </div>
                                </div><br /><br />
                                <div class="col-md-12">
                                    <div class="form-floating">
