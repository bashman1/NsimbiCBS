...
$title = 'OVER-DUE LOANS REPORT';

require_once('includes/response.php');
require_once('includes/ReportService.php');
$ReportService = new ReportService();
$request_data = ['ReportModel' => 'TransactionReport', 'ReportModelMethod' => 'getWrittenOffLoansLedgerReport2', 'is_expense_report' => false, 'branchId' => @$_REQUEST['branch'], 'loan_product_id' => @$_REQUEST['acid'] ?? 0, 'transaction_end_date' => @$_REQUEST['transaction_end_date'] ?? date('Y-m-d'), 'bank_id' => @$user[0]['bankId']];
...
$report_type = "OVER-DUE LOANS REPORT";
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td> <?= @$record['arrears_days'] ?> </td>

                                        <td> <?= number_format(@$record['principal_arrears'] ?? 0) ?> </td>
                                        <td> <?= number_format(@$record['interest_arrears'] ?? 0) ?> </td>
                                ...
                                <?php
                                    ...
                                    $total_write_off += (int) (@$record['principal_arrears']);

                                    $total_write_off_i += (int) (@$record['interest_arrears']);
                                } ?>
                                ...
                                <tr>
                                    <th colspan="10">Total Principal in Arrears </th>
                                    <th class="text-center"> <?= number_format($total_write_off) ?> </th>

                                </tr>
                                <tr>
                                    <th colspan="10">Total Interest in Arrears </th>
                                    <th class="text-center"> <?= number_format($total_write_off_i) ?> </th>
