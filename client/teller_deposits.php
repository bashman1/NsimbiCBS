    ...
    <script type="text/javascript">
        ...
        function bindtoDatatable(data) {
            ...
            var table = $('#example3').dataTable({
                ...
                ajax: {
                    url: `<?= BACKEND_BASE_URL ?>Bank/get_all_transactions_datatables.php?bankId=<?= $user[0]['bankId'] ?>&branch=<?= $user[0]['branchId'] ?>&branchId=<?= @$_REQUEST['branchId'] ?>&transaction_type=D&deposit_method=<?= @$_REQUEST['deposit_method'] ?>&approved_by_id=<?= @$user[0]['userId'] ?>&account_id=<?= @$_REQUEST['account_id'] ?>&start_date=<?= date('Y-m-d')?>&end_date=<?= date('Y-m-d') ?>`,
                                    ...
                                    <div class="dropdown custom-dropdown mb-0">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item"
                                                href="edit_deposit?id=${record.tid}"> <i class="fa fa-eye"></i> Edit Deposit </a>
                                        </div>
                                    </div>
                                `,
                            })
