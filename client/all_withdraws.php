                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php } else { ?>
                                            <select class=" form-control " id="select2" name="branchId">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class=" form-control " name="savings_account_id" id="village">
                                            <option value=""> All </option>
                                            <?php
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="withdraw_method" class=" form-control " id="countries">
                                            <option value="">All</option>
    ...
    <script type="text/javascript">
        ...
        function bindtoDatatable(data) {
            ...
            var table = $('#example3').dataTable({
                ...
                ajax: {
                    url: `<?= BACKEND_BASE_URL ?>Bank/get_all_transactions_datatables.php?bankId=<?= $user[0]['bankId'] ?>&branch=<?= $user[0]['bankId'] == '' ? $user[0]['branchId'] : '' ?>&branchId=<?= @$_REQUEST['branchId'] ?>&transaction_type=W&withdraw_method=<?= @$_REQUEST['withdraw_method'] ?>&approved_by_id=<?= @$_REQUEST['approved_by_id'] ?>&savings_account_id=<?= @$_REQUEST['savings_account_id'] ?>&start_date=<?= @$_REQUEST['start_date'] ?>&end_date=<?= @$_REQUEST['end_date'] ?>`,
                                ...
                                'actions': `
                                    <div class="dropdown custom-dropdown mb-0">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item confirm delete-record"
                                                href="edit_withdraw.php?tid=${record.tid}&t=${encrypt_data(record.mid)}"> <i class="fa fa-eye"></i>Edit Withdraw </a>
                                                <a class="dropdown-item text-danger confirm delete-record"
                                                href="trash_withdraw.php?id=${record.tid}"> <i class="fa fa-trash"></i>Trash Withdraw </a>
                                        </div>
                                    </div>
                                `,
                            })
