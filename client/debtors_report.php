...
$request_data = ['ReportModel' => 'ClientReport', 'ReportModelMethod' => 'getDebtorsReport'];
                ...
                <div class="card">
                    ...
                    <div class="card-body report-section" id="exreportn">
                        ...
                        <table class="main-header">
                            <tr>
                                <td> <strong> Debtors' Report: </strong> </td>
                            </tr>
                        </table>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td> <?= @$member['cname'] ?> </td>
                                        <td> <?= @$member['bname'] ?> </td>
                                        <td> <?= normal_date_short(@$member['datecreated']) ?> </td>
                                        <td> <?= number_format(@$member['tot_receivable']) ?> </td>
                                        <td> <?= number_format(@$member['tot_paid']) ?> </td>
                                        <td> <?= number_format(@$member['tot_bal']) ?> </td>


                                    </tr>
                                <?php

                                    $total_amount += @$member['tot_receivable'];
                                    $total_paid += @$member['tot_paid'];
                                    $total_bal += @$member['tot_bal'];
                                } ?>
                                <tr>
                                    <th colspan="7">Total Receivable Amount</th>
                                    <th class="text-center"> <?= number_format($total_amount) ?> </th>
                                </tr>
                                <tr>
                                    <th colspan="7">Total Amount Paid</th>
                                    <th class="text-center"> <?= number_format($total_paid) ?> </th>
                                </tr>
                                <tr>
                                    <th colspan="7">Total Balance</th>
