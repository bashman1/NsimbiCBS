                ...
                <div class="card">
                    ...
                    <div class="card-body report-section" id="exreportn">
                        ...
                        <table class="main-header">
                            <tr>
                                <td> <strong> <?= 'Account Statement Reconciliations' ?> </strong> </td>
                            </tr>
                        </table>
                        ...
                        <table class="report_table">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td><?= @$record['rec_id'] ?></td>
                                        <td> <?= normal_date(@$record['rec_date']) ?> </td>
                                        <td> <?= @$record['trashed_by_names'] ?> </td>
                                        <td> <?= @$record['rec_client_name'] ?> </td>
                                        <td><?= @$record['rec_reason'] ?></td>

                                        <td><?= @$record['rec_option'] ?></td>
                                        <td><?= number_format(@$record['rec_acc_bal']) ?></td>
                                        <td><?= number_format(@$record['rec_other_amount']) ?></td>
                                        <td><?= number_format(@$record['rec_closing_bal']) ?></td>
                                        <td><?= number_format(@$record['rec_freezed_bal']) ?></td>


                                        <td> <?= $record['rec_created_trxn'] ?> </td>
                                        <td> <?= $record['rec_trxn_tid'] ?> </td>

                                        <td> <?= normal_date_short(@$record['rec_date_entered']) ?> </td>
