            ...
            <div class="container-fluid">
                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">
                                    ...
                                    Search the Account to Transfer Money from
                                </h4>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="mt-0 header-title">Transferer Account Search Query </h4>
                    ...
                    mySuccess();
                                ...
                                <form method="post" action="<?= BACKEND_BASE_URL ?>Bank/search_clients_transfer.php?branch=<?php echo $user[0]['branchId']; ?>&bank=<?php echo $user[0]['bankId']; ?>">
