                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="income_ledger" class="table table-striped export-datatable" style="min-width: 845px;" data-title="Expenses Ledger">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Description</th>
    ...
    ***********************************-->
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                url: '<?= BACKEND_BASE_URL ?>Bank/get_all_bank_transactions_expenses.php?branch=<?= $user[0]['bankId'] == '' ? $user[0]['branchId'] ?? $_REQUEST['branchId'] : '' ?>&bank=<?php echo $user[0]['bankId']; ?>&acid=<?= @$_REQUEST['main_acc'] ?>&start_date=<?= @$_REQUEST['start_date'] ?? date('Y-m-d') ?>&end_date=<?= $_REQUEST['end_date'] ?? date('Y-m-d') ?>',
                type: 'GET',
                dataType: 'json',
