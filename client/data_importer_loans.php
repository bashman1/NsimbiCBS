                                    ...
                                    <div class="col-lg-12">
                                        <div class="row">
                                            ...
                                            <ul class="nav nav-tabs" role="tablist">
                                                <li class="nav-item">
                                                    <a href="#loans" data-bs-toggle="tab" class="nav-link  active">Loans</a>
                                                </li>
                                            </ul>

                                            <div class="tab-content">
                                                <div id="loans" class="tab-pane fade active show">

                                                    <div class="d-flex align-items-center bd-highlight mt-2">
                                                        <h3 class="mb-2">Import Loans</h3>
                                                        <a href="documents/data_importer_loans_detailed.xlsx" class="btn btn-primary light btn-xs mb-1 p-2 bd-highlight ms-4">
                                                            <i class="fas fa-file-excel"></i> Download Detailed Version Excel Template
                                                        </a>

                                                        <a href="documents/data_importer_loans_short.xlsx" class="btn btn-primary light btn-xs mb-1 p-2  ms-4 bd-highlight">
                                                            <i class="fas fa-file-excel"></i> Download Short Excel Template
                                                        </a>

                                                    </div>
                                                    <hr>
                                                    <form action="data_importer_loans" id="data_importer_loans" class="mt-1 data-importer-form" method="post" enctype="multipart/form-data" data-reload-page="1">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-5">
                                                                <div class="input-group mb-2">
                                                                    ...
                                                                    <div class="form-file">
                                                                        <input type="file" name="loans_data_file" class="form-file-input form-control" id="loans_upload">
                                                                    </div>
                                                                </div>
                                                            </div>

                                                            <div class="col-md-3 hide" id="loans_upload_data_actions">
                                                                <div class="d-grid">
                                                                    <button type="submit" id="submit_btn" name="loans_data" class="btn btn-primary btn-sm btn-submit">
                                                                        Import Data
                                                                    </button>
                                                        ...
                                                        <input type="hidden" name="accepted_files" class="accepted_files" value="data_importer_loans_detailed|data_importer_loans_short">

                                                    </form>
                                                    <div class="table-responsive mb-4">
                                                        <div id="loans_upload_data_section">
                                                        </div>
                                                    </div>

                                                    <div class="mb-4">
                                                        <div id="loans_upload_data_importer_totals">
                                                        </div>
                                                    </div>
...
<script type="text/javascript">
    ...
    function getLoansBatches() {
        var table = $('#batches_table').dataTable({
            ...
            ajax: {
                url: '<?= BACKEND_BASE_URL ?>Bank/get_data_importer_loan_batches.php?bank_id=<?= $_SESSION['user']['bankId']; ?>&branch=<?php echo $user[0]['branchId']; ?>',
                type: 'GET',
                dataType: 'json',
                    ...
                    for (let record of data) {
                        ...
                        actions += `    
                                            <a class="dropdown-item"
                                                href="data_importer_batch_loans.php?id=${record.batch_id}"> <i class="fa fa-eye"></i> View Loans </a>`;
                        if (record.batch_status == false) {
                            actions += `<a class="dropdown-item confirm-action"
                                                href="data_importer_batch_loans_dispatch.php?id=${record.batch_id}"> <i class="fa fa-share"></i> Move to main database </a>
                                                
                                                <a class="dropdown-item text-danger delete-record"
                                                href="delete_loan_batch.php?id=${record.batch_id}"> <i class="fa fa-trash"></i> Trash </a>
                        ...
                        datatable_data.push({
                            ...
                            'batch_name': `<a href="data_importer_batch_loans.php?id=${record.batch_id}">${record.batch_name}</a>`,
