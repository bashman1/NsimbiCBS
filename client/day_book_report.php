...
$request_data = ['ReportModel' => 'TransactionReport', 'ReportModelMethod' => 'getDayTransactionReport', 'is_savings_report' => true];
                    ...
                    <div class="card-header">
                        ...
                        ?>
                            <div>
                                ...
                                <a href="export_report.php?exportFile=report_day_book&<?= $request_string ?>&orientation=landscape" target="_blank" class="btn btn-primary light btn-xs">
                    ...
                    <div class="card-body report-section">
                        ...
                        <table>
                            ...
                            <?php if (@$_REQUEST['transaction_type']) :
                                ...
                                } else if (@$_REQUEST['transaction_type'] == "I" || @$_REQUEST['transaction_type'] == "C") {
                            ...
                            <tbody>
                                ...
                                foreach ($records as $record) {
                                    ...
                                    if (@$record['t_type'] == "D") {
                                        ...
                                        $ttn = 'Expense Entry';
                                    } else if (@$record['t_type'] == "I" || @$record['t_type'] == "R" || @$record['t_type'] =='C' || @$record['t_type'] =='SMS') {
                                        $ttn = 'Income Entry';
