...
if (isset($_POST['submit'])) {
    ...
    $res = $response->createDeposit($_POST['client'], $amount, $_POST['comment'], $_POST['depositor_name'], $_POST['record_date'], $_POST['pay_method'], $_POST['bank_acc'], $_POST['cheque_no'], $_POST['cash_acc'], $send_sms, $_POST['branch'], $user[0]['userId'], $_POST['depositor_phone']);
    if ($res['success']) {
        // show swal to ask for print receipt
        // header('location: receipt?id=' . $res['message'] . '&type=D');
        setSessionMessageWithConfirm(true, 'Deposit Created Successfully!', $res['message'], 'D');
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="mt-0 header-title">
                                    <a href="search_client.php" class="btn btn-primary light btn-xs mb-1 "><i class="fa fa-arrow-left"></i> Back</a> | Savings Deposit Form
                                </h4>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-lg-6 col-6 mb-2 mb-lg-0">
                                                        ...
                                                        <input type="date" name="record_date" class="form-control" value="<?php echo date('Y-m-d'); ?>" required max="<?php echo date('Y-m-d'); ?>">
                                                    </div>
                                                    <!--end col-->
