                    ...
                    <div class="card-header">
                        ...
                        ?>
                            <div>
                                ...
                                <a href="https://app.ucscucbs.net/backend/api/Bank/export_clients.php?branch=<?= @$_REQUEST['branchId'] ?>&bank=<?= @$user[0]['bankId'] ?>&type=&product=<?= @$_REQUEST['actype'] ?>&st=<?= @$_REQUEST['start_date'] ?>&end=<?= @$_REQUEST['end_date'] ?>" class="btn btn-primary light btn-xs">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center"> <?= @$member['total_loans'] ?> </td>
                                    </tr>
                                <?php
                                ...
                                <tr>
                                    <th colspan="7">Total A/C Balances</th>
                                    <th class="text-center"> <?= number_format($total_bal) ?> </th>
                                </tr>
                                <tr>
                                    <th colspan="7">Total Loans</th>
                                    <th class="text-center"> <?= number_format($total_loans) ?> </th>
                                </tr>
                                <tr>
                                    <th colspan="7">Total Clients</th>
                                    <th class="text-center"> <?= number_format(count($members)) ?> </th>
                                </tr>
                            </tbody>
                        </table>
