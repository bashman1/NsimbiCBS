                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select id="bankacc" class=" form-control" name="cash_account">
                                                    ...
                                                    } else if ($permissions->hasPermissions('create_all_cash_transfers')) {
                            ...
                            <div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <a target="_blank" class="btn btn-primary btn-sm" href="export_report.php?exportFile=export_teller_till_sheet&useFile=1&start=<?= @$_REQUEST['from_date'] ?? date('Y-m-d') ?>&end=<?= @$_REQUEST['to_date'] ?? date('Y-m-d') ?>&staff=<?= @$_REQUEST['cash_account'] ?? 0 ?>">
