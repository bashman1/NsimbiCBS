...
if (isset($_POST['submit'])) {
    ...
    $cash_acc =
        $_POST['cash_acc'] ?? 0;
    $_POST['account_id'] = $_POST['account_id'] ?? 0;
    $_POST['bank_acc'] = $_POST['bank_acc'] ?? 0;
    $res = $response->createIncome($_POST['heading'], $_POST['amount'], $_POST['main_acc'], $_POST['pay_method'], $_POST['bank_acc'], $cash_acc, $_POST['account_id'], $_POST['cheque_no'], $_POST['date_of_p'], $_POST['comment'], $user[0]['bankId'], $_POST['branch'], $user[0]['userId']);
    if ($res) {
        setSessionMessage(true, 'Income Registered Successfully!');
        header('location:accounting_tab.php');
        exit;
    } else {
        setSessionMessage(false, 'Something went wrong! Try again');
        header('location:register_income.php');
        exit;
    }
}
$title = 'INCOME ENTRY';
                                        ...
                                        <select name="main_acc" class="form-control" id="journalacc">
                                            ...
                                            if ($sub_accs) {
                                                ...
                                                foreach ($sub_accs as $acc) {
                                                    if ($acc['type'] == 'INCOMES' && $acc['is_main_account'] == 0) {
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select id="payment_methods" name="pay_method" class="form-control">
                                            ...
                                            <option value="saving" selected>Offset from Member's Savings</option>
                                        </select>
