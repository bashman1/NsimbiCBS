            ...
            <div class="container-fluid">
                <!-- <div class="row page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Client's Transaction Statement</a></li>
                    </ol>
                </div> -->
                <!-- row -->
                <div class="row">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title text-primary">Savings Statement</h4>
                            ...
                            <div class="table-responsive recentOrderTable">
                                <table class="table table-striped" style="min-width: 845px">
                                    <thead>
                                        ...
                                        <tr>
                                            <th colspan="7" style="text-align:center;">STATEMENT OF SAVINGS</th>
                                        </tr>
                                        <tr>
