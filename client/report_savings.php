...
$request_data = ['ReportModel' => 'TransactionReport', 'ReportModelMethod' => 'getTransactionReport', 'is_savings_report' => true];
$request_data = array_merge($request_data, $_REQUEST);
$_REQUEST['transaction_start_date'] = @$_REQUEST['transaction_start_date'] ?? date('Y-m-d', strtotime('-1 days'));
                    ...
                    <div class="card-header">
                        ...
                        ?>
                            <div>
                                ...
                                <!-- <a href="export_report.php?exportFile=report_savings&<?= $request_string ?>&orientation=landscape" target="_blank" class="btn btn-primary light btn-xs">
