        ...
        <div class="content-body">
            <div class="container-fluid">
                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                <div class="row ps-5 mt-4">
                                    ...
                                    Account Status <a class="btn btn-<?= $member['status'] == 'ACTIVE' ? 'primary' : 'danger' ?> light btn-xs mb-1"><?= $member['status'] == 'INACTIVE' ? 'DEACTIVATED' : $member['status']; ?></a>
                                        ...
                                        <p class="mb-0">
                                            <a href="client_profile_page.php?id=<?= encrypt_data(@$client_id); ?>" class="btn btn-primary light btn-xs mb-1 me-2">More Details</a>
                                        </p>
                                        <!-- <p class="mb-0">
                                    <span class="text-muted">A/C Balance: </span>
                                    <?php echo number_format($member['balance'] ?? 0); ?>
                                    ...
                                    <div class="col  ps-0 pt-3">
                                        <p class="float-right" style="float: right;">Available funds</p>
                                        <p class="fw-bold fs-2 mt-10" style="float: right;"> UGX <?php echo number_format($member['balance'] ?? 0.00); ?></p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <p class="fw-bold fs-4 p-0 m-0">NSIMBI A/C Details</p>
                                        <p class="fs-5 mb-20">88 1240 7793 7644 3667 0002 9448 <i class="fa fa-arrow-right"></i></p>
                                        <!-- <a href="add_client_account.php?id=<?= encrypt_data(@$client_id); ?>" class="btn btn-primary light btn-xs mb-1 me-2">Savings A/Cs (<?= number_format(@$member['accs']); ?>)</a> -->

                                        <!-- <div class="row">
                                            
                                        </div> -->
                                        <a href="add_deposit.php?t=<?= encrypt_data(@$client_id); ?>" class="btn btn-primary light btn-xs mb-1 me-2">Deposit</a>
                                        <a href="add_client_account.php?id=<?= encrypt_data(@$client_id); ?>" class="btn btn-primary light btn-xs mb-1 me-2">Withdraw</a>
                                        <a href="add_client_account.php?id=<?= encrypt_data(@$client_id); ?>" class="btn btn-primary light btn-xs mb-1 me-2">Transfer</a>
                                        <!-- <a class="btn btn-primary light btn-xs mb-1 me-2" data-bs-toggle="modal" data-bs-target="#stmtsModal">View Statements</a> -->
                                        ...
                                        <?php if ($permissions->hasSubPermissions('delete_client')) { ?>
                                            <!-- <a > -->
                                            <form id="deactivate" style="display: inline;" method="get"> <input type="hidden" class="form-control" name="did" value="<?= $member['userId'] ?>"><input type="hidden" class="form-control" name="status" value="INACTIVE"> <button type="submit" class="btn btn-danger light btn-xs mb-1">Deactivate A/C</button></form>
                                            <!-- </a> -->
                                        <?php } ?>

                                        <?php if ($permissions->hasSubPermissions('delsub_permissions: ete_client')) { ?>
                                            <form id="delete_member" style="display: inline;" method="get"> <input type="hidden" class="form-control" name="del_id" value="<?= $member['userId'] ?>"> <button type="submit" class="btn btn-danger light btn-xs mb-1 confirm ">Delete A/C</button></form>
                                        <?php } ?>
                                        <!-- <button class="btn btn-success light btn-xs mb-1 confirm">Deposit </button>
                                        <button class="btn btn-success light btn-xs mb-1 confirm">Withdraw </button>
                                        <button class="btn btn-success light btn-xs mb-1 confirm">Transfer </button> -->
                                        <!-- <button class="btn btn-light">Link accounts</button> -->
                                    </div>
                                    <!-- <div class="col-md-4">
                                        <div>
                                        <p class="fw-bold fs-2 mt-10" style="float: right;"> <?php echo number_format($member['balance'] ?? 0.00); ?></p>
                                        </div>
                                    </div> -->
                                </div>
                            </div>
                    ...
                    <div class="col-md-5">
                        <div class="card" style="background-color: #004d00; color: #ffffff;">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-10">
                                        <p class="fw-bold fs-4">Define standing orders</p>

                                        <p>NevBank Savings Account NevBank Savings Account
                                            NevBank Savings Account NevBank Savings Account
                                        </p>
                                        <!-- <button class="btn btn-light">Edit</button> -->
                                        <a href="client_profile_page.php?id=<?= encrypt_data(@$client_id); ?>" class="btn btn-primary light btn-xs mb-1 me-2">Edit</a>
                                    </div>
                                    <div class="col-md-2">
                                        <p class="fs-3"><i class="fas fa-ellipsis-h"></i></p>
                                        <p class="fs-1"><i class="fas fa-calendar-alt"></i></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <p class="fs-5 fw-bold">Last Month</p>
                                        <div id="chart"></div>
                                    </div>
                                </div>
                            </div>
