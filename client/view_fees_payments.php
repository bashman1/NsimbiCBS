                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="deposit_method" class="me-sm-2 default-select form-control wide" style="display: none;">
                                            <option value="">All </option>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="example3" class="table table-striped dataTable" style="min-width: 845px">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Amount</th>
    ...
    <script type="text/javascript">
        ...
        function bindtoDatatable(data) {
            ...
            var table = $('#example3').dataTable({
                ...
                ajax: {
                    url: `<?= BACKEND_BASE_URL ?>Bank/get_all_transactions_datatables_fees.php?bankId=<?= $user[0]['bankId'] ?>&branch=<?= $user[0]['bankId'] == '' ? $user[0]['branchId'] : '' ?>&branchId=<?= @$_REQUEST['branchId'] ?>&transaction_type=D&deposit_method=<?= @$_REQUEST['deposit_method'] ?>&approved_by_id=<?= @$_REQUEST['approved_by_id'] ?>&account_id=<?= @$_REQUEST['account_id'] ?>&start_date=<?= @$_REQUEST['start_date'] ?>&end_date=<?= @$_REQUEST['end_date'] ?>`,
                    ...
                    dataSrc: function(response) {
                        ...
                        for (let record of data) {
                            ...
                            datatable_data.push({
                                ...
                                'sterm': record.sterm ?? '',
                                'parent': `${record.parent_name} - ${record.parent_phone}`,
                                'name': `${record.shared_name ? record.shared_name : ''} ${record.lastName ? record.lastName : ''}`,
                                'print': ` <button class="btn btn-success btn-sm edit btn-flat"> <a target="_blank" href="receipt.php?id=${record.tid}&type=S" style="color:#fff !important;">Print</a></button>`,
                                'status': status_label,
                                    ...
                                    <div class="dropdown custom-dropdown mb-0">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item"
                                                href="edit_deposit_fees.php?id=${record.tid}"> <i class="fa fa-eye"></i> Edit Deposit </a>
                                        </div>
                                    </div>
                                `,
                            })
