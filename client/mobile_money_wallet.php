                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <?php if ($permissions->hasSubPermissions('initiate_ussd_push')) { ?>
                            <a href="ussd_push.php" class="btn btn-primary light btn-xs mb-1" target="_blank">Initiate USSD Push</a>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="example3" class="display" style="min-width: 845px">
                                ...
                                <tbody>
                                    <?php
                                    $sm = $response->getWalletDetails($user[0]['bankId']);
                                    ?>
                                    <tr>
                                        <td>Wallet Balance</td>
                                        <td><?php echo number_format($sm['data']['balance']??0); ?></td>


                                    </tr>
                                    <tr>
                                        <td>Currency</td>
                                        <td><?php echo $sm['data']['currency']??'UGX'; ?></td>
