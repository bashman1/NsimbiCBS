...
$title = 'SHARE PURCHASES LEDGER REPORT';


require_once('includes/response.php');
require_once('includes/ReportService.php');
$ReportService = new ReportService();
$request_data = ['ReportModel' => 'TransactionReport', 'ReportModelMethod' => 'getshareLedgerReport', 'is_expense_report' => false, 'branchId' => $_GET['branch'], 'loan_product_id' => 0];
...
$report_type = "Share Purchases Report";
                    ...
                    <div class="card-body report-section">
                        ...
                        <table class="report_table">
                            ...
                            <tbody>
                                ...
                                <?php
                                    $total_ac += (int) $record['amount'];
                                    $total_sh += (int) $record['no_of_shares'];
                                } ?>

                                <tr>
                                    <th colspan="3">Totals (<?= number_format($i) ?>) </th>
                                    <th> <?= number_format($total_ac) ?> </th>
                                    <th> <?= number_format($total_sh) ?> </th>
                                </tr>
                            </tbody>
                        </table>
