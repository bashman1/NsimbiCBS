...
$request_data = ['ReportModel' => 'ClientReport', 'ReportModelMethod' => 'getCreditorsReport'];
                ...
                <div class="card">
                    ...
                    <div class="card-body report-section" id="exreportn">
                        ...
                        <table class="main-header">
                            <tr>
                                <td> <strong> Creditors' Report: </strong> </td>
                            </tr>
                        </table>
                        ...
                        <table class="report_table">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td> <?= $tot_count ?> </td>
                                        <td> <?= @$member['cred_name'] ?> </td>
                                        <td> <?= @$member['cname'] ?> </td>
                                        <td> <?= @$member['bname'] ?> </td>
                                        <td> <?= normal_date_short(@$member['datecreated']) ?> </td>
                                        <td> <?= number_format(@$member['tot_payable']) ?> </td>
                                ...
                                <?php
                                    ...
                                    $total_amount += @$member['tot_payable'];
