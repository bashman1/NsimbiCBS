                        ...
                        <div class="card">
                          ...
                          ';
                            ...
                            ';
                                        ...
                                        <div class="col-lg-6 mb-2">
                                            <div class="mb-3">
                                                <label class="text-label form-label">Select Bank A/C:
                                                    *</label>
                                                <select id="bankacc" class="form-control" name="sender" required>
                                                    ...
                                                    if ($bank_accounts) {
                                                        ...
                                                        foreach ($bank_accounts as $b_acc) {
                                                            echo '<option value="' . $b_acc['cid'] . '" data-bal="' . $b_acc['balance'] . '">' . $b_acc['accno'] . ' - ' . $b_acc['account_name'] . ' - Balance: ' . number_format($b_acc['balance']) . '</option>';
                                                        }
                                                    }
                                        ...
                                        <div class="col-lg-6 mb-2">
                                            <div class="mb-3">
                                                <label class="text-label form-label">Select Reserve A/C being affected:
                                                    *</label>
                                                <select class=" form-control " id="reserveacc" name="receiver" required>
