...
if (!$permissions->IsBankStuff() || !$permissions->hasSubPermissions('update_deposit')) {
...
if (isset($_POST['submit'])) {
    ...
    $res = $response->editDeposit($_POST['client'], $amount, $_POST['comment'], $_POST['depositor_name'], $_POST['record_date'], $_POST['pay_method'], $_POST['bank_acc'], $_POST['cheque_no'], $_POST['cash_acc'], $send_sms, $_POST['branch'], $user[0]['userId'], $_POST['tid'], $orig_amount,$_POST['orig_acid']);
    if ($res) {
        setSessionMessage(true, 'Deposit Updated Successfully!');
    } else {
        setSessionMessage(false, 'Something went wrong! Try again to update deposit.');
    }
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="mt-0 header-title">
                                    <a href="javascript:;" class="btn btn-primary light btn-xs mb-1 is-back-btn hide"><i class="fa fa-arrow-left"></i> Back</a> | Savings Deposit Update Form
                                </h4>
                          ...
                          ';
                                            ...
                                            <div class="form-group">
                                                <label>Notes</label>
                                                <textarea class="form-control" rows="5" name="comment" placeholder="write here.."><?= $trxn['notes'] ?></textarea>
                                            </div>
