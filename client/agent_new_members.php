            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <?= $_GET['n'] ?? '' ?> - Clients Registered Today

                        <?php if ($permissions->hasSubPermissions('delete_agent_transactions')) { ?>
                            <a href="trash_all_agent_members.php" class="btn btn-primary light btn-xs mb-1">Delete All Entries</a>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <table id="clients_datatable" class="display fixed-layout" style="min-width: 845px;">
        ...
        function bindtoDatatable() {
            ...
            var table = $('#clients_datatable').dataTable({
                ...
                ajax: {
                    ...
                    url: `<?= BACKEND_BASE_URL ?>User/get_all_bank_clients_datatables_agent.php?bank=<?= $user[0]['bankId'] ?>&branch=<?= $user[0]['branchId'] ?>&branchId=<?= @$_REQUEST['branch'] ?>&client_type=<?= @$_REQUEST['client_type'] ?>&gender=<?= @$_REQUEST['gender'] ?>&actype=<?= @$_REQUEST['actype'] ?>&start_date=<?= @$_REQUEST['start_date'] ?>&end_date=<?= @$_REQUEST['end_date'] ?>&client_type_section=individual&agent=<?= $_GET['id']?>`,
