...
$request_data = ['ReportModel' => 'ClientReport', 'ReportModelMethod' => 'FixedDepositScheduleReport', 'is_client_type' => 1];
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        ?>
                            <div>
                                ...
                                <!-- <a href="export_report?exportFile=report_fixed_deposit&<?= $request_string ?>&orientation=landscape&rtt=Closed Fixed Deposits Report" target="_blank" class="btn btn-primary light btn-xs">
                    ...
                    <div class="card-body report-section" id="exreportn">
                        ...
                        <table class="main-header">
                            <tr>
                                <td> <strong> Closed Fixed Deposits Report: </strong> </td>
                            </tr>
                        </table>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td> <a href="fixed_deposit_details?id=<?= $member['fd_id'] ?>" class="text-primary"><?= number_format($member['fd_amount'] ?? 0); ?> </a></td>
