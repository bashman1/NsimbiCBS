...
if (isset($_POST['submit'])) {
    $res = $response->registerShortfall($_POST);
    if ($res) {
        setSessionMessage(true, 'Shortfall Registered Successfully!');
        header('location:staff_shortfall.php');
    } else {
        setSessionMessage(false, 'Something went wrong! Try again.');
        header('location:register_shortfall.php');
    }
    exit;
}
    ...
    ';
                          ...
                          ';
                            ...
                            ';
                                    ...
                                    <div class="form-group">
                                        <label>Select Shortfall Journal Account: </label>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-block" name="submit">Enter Shortfall</button>
