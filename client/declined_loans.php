...
if (!$permissions->IsBankStuff()  || !$permissions->hasSubPermissions('view_declined_loans')) {
            ...
            <div class="container-fluid">
                ...
                <!-- <div class="row page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">All Declined Loans</a></li>
                    </ol>
                </div> -->
                <!-- row -->
                    ...
                    <div class="card-body">
                        ...
                        <form class="ajax_results_form" method="get">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <label class="text-label form-label">Payment Frequency *</label>

                                        <select name="frequency" class="me-sm-2 default-select form-control wide" style="display: none;">
                                            <option value="">--- All ---</option>
                                            <option value="1" <?= @$_REQUEST['frequency'] == 1 ? "selected" : "" ?>>Daily</option>
                                            <option value="2" <?= @$_REQUEST['frequency'] == 2 ? "selected" : "" ?>>Weekly</option>
                                            <option value="3" <?= @$_REQUEST['frequency'] == 3 ? "selected" : "" ?>>Monthly</option>
                                            <option value="4" <?= @$_REQUEST['frequency'] == 4 ? "selected" : "" ?>>Bi-Monthly</option>
                                            <option value="5" <?= @$_REQUEST['frequency'] == 5 ? "selected" : "" ?>>Annually</option>
                                        </select>
                                    </div>
                                </div>
                            </div><br />
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="text-label form-label">Decline Start Date *</label>
                                        <input type="date" class="form-control" name="declined_start_date" value="<?= @$_REQUEST['declined_start_date'] ?>" placeholder="Start Date">
                                    </div>
                                </div>

                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="text-label form-label">Decline End Date *</label>
                                        <input type="date" class="form-control" name="declined_end_date" value="<?= @$_REQUEST['declined_end_date'] ?>" placeholder="End Date">
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        ...
        function bindtoDatatable() {
            ...
            var table = $('#example3').dataTable({
                ...
                ajax: {
                    url: `<?= BACKEND_BASE_URL ?>Bank/get_all_loans_datatables.php?bankId=<?= $user[0]['bankId'] ?>&branch=<?= $user[0]['bankId'] == '' ? $user[0]['branchId'] : '' ?>&branchId=<?= @$_REQUEST['branchId'] ?>&status=6&loan_status=<?= @$_REQUEST['loan_status'] ?>&loan_product_id=<?= @$_REQUEST['loan_product_id'] ?>&frequency=<?= @$_REQUEST['frequency'] ?>&declined_start_date=<?= @$_REQUEST['declined_start_date'] ?>&declined_end_date=<?= @$_REQUEST['declined_end_date'] ?>`,
                    ...
                    dataSrc: function(response) {
                        ...
                        for (let record of data) {
                            ...
                            var status_label = '<span class="badge light badge-warning">DECLINED</span>';
                            ...
                            datatable_data.push({
                                ...
                                'duration': `${record.approved_loan_duration
                                                    } - ${ frequency}`,
                                ...
                                'actions': ` <div class = "dropdown custom-dropdown mb-0" ><div class = "btn sharp btn-primary tp-btn" data - bs - toggle = "dropdown" ><svg xmlns = "http://www.w3.org/2000/svg" xmlns: xlink = "http://www.w3.org/1999/xlink" width = "18px" height = "18px" viewBox = "0 0 24 24" version = "1.1" ><g stroke = "none" stroke-width = "1" fill="none" fill-rule ="evenodd" ><rect x="0" y="0" width="24" height="24"></rect><circle fill = "#000000" cx = "12" cy = "5" r = "2"></circle> <circle fill = "#000000" cx = "12" cy = "12" r = "2" ></circle> <circle fill = "#000000" cx="12" cy="19" r="2"></circle></g></svg> </div><div class = "dropdown-menu dropdown-menu-end" ><a class="dropdown-item" href = "loan_details_page.php?id=${record.loan_no}" > < i class = "fa fa-eye" > < /i> View Loan Details </a ></div></div>`,
                            })
                        }
