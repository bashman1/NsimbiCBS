...
<head>
    ...
    <meta name="description" content="UCSCU CBS  : Best Banking Platform" />
    <meta property="og:title" content="UCSCU CBS  : Banking Platform for Financial Institutions" />
    <meta property="og:description" content="UCSCU CBS  : SACCOs,MFIs,Banks,Money Lending Institutions" />
    <meta property="og:image" content="icons/favicon.png" />
    <meta name="format-detection" content="telephone=no">

    <!-- PAGE TITLE HERE -->
    <title>NSIMBI CBS | LOAN APPLICATIONS</title>
    ...
    <script type="text/javascript">
        function mySuccess2() {
            swal({
                    title: "Kindly note this!",
                    text: 'You have to approve & disburse this loan, then after make manaul repayment collections of all the paid installment amount (based on the schedule) on this loan as of today',
                    type: "warning",
                    confirmButtonText: 'I Understand this',
                    confirmButtonColor: '#f70707'
                },
                function() {
            ...
            <div class="container-fluid">
                ...
                <!-- <div class="row page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">All Loan Applications</a></li>
                    </ol>
                </div> -->
                <!-- row -->
                ...
                <div class="card">
                    ...
                    mySuccess2();
                        ...
                        <div class="btn-group" role="group">
                            <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">Add New Loan</button>
                            <div class="dropdown-menu" style="margin: 0px;">
                                <a class="dropdown-item" href="add_loan.php?l=1">New Loan Application</a>
                                <a class="dropdown-item" href="add_loan.php?l=2">Old / Existing Loan</a>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="loan_applications_table" class="table table-striped" style="min-width: 845px;">
                                <thead>
                                    <tr>
                                        <th>Loan No.</th>
                                        <th>A/C No.</th>
    ...
    ***********************************-->
    ...
    <script type="text/javascript">
        ...
        function bindtoDatatable() {
            ...
            var table = $('#loan_applications_table').dataTable({
                destroy: true,
                processing: true,
                serverSide: true,
                searchable: true,
                ...
                ajax: {
                    url: `<?= BACKEND_BASE_URL ?>Bank/get_all_loans_datatables.php?bankId=<?= $user[0]['bankId'] ?>&branch=<?= $user[0]['bankId'] == '' ? $user[0]['branchId'] : '' ?>&branchId=<?= @$_REQUEST['branchId'] ?>&status=0&loan_status=<?= @$_REQUEST['loan_status'] ?>&loan_product_id=<?= @$_REQUEST['loan_product_id'] ?>&disbursement_date=<?= @$_REQUEST['disbursement_date'] ?>&application_start_date=<?= @$_REQUEST['application_start_date'] ?>&application_end_date=<?= @$_REQUEST['application_end_date'] ?>`,
                    ...
                    dataSrc: function(response) {
                        ...
                        for (let record of data) {
                            ...
                            var status_label = '<span class="badge light badge-warning">PENDING REVIEW</span>';
