...
$request_data = ['ReportModel' => 'ClientReport', 'ReportModelMethod' => 'getSharePurchasesReport'];
                ...
                <div class="card">
                    ...
                    <div class="card-body report-section" id="exreportn">
                        ...
                        <table class="main-header">
                            <tr>
                                <td> <strong> Share Purchases Report: </strong> </td>
                            </tr>
                        </table>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td> <?= @$member['pay_method'] ?> </td>
                                            <td> <?= @$member['auth_by'] ?> </td>

                                            <td class="text-center"> <?= number_format(@$member['no_of_shares'] ?? 0) ?> </td>
                                            <td class="text-center"> <?= number_format(@$member['current_share_value'] ?? 0) ?> </td>
                                            <td class="text-center"> <?= number_format(@$member['amount'] ?? 0) ?> </td>

                                        </tr>
                                <?php
                                        $total_bal +=  @$member['no_of_shares'];
                                        $total_loans +=  @$member['amount'];
                                    }
                                } ?>
                                <tr>
                                    <th colspan="7">Total Shares Purchased</th>
                                    <th class="text-center"> <?= number_format((float)$total_bal, 2, '.', '') ?> </th>
                                </tr>
                                <tr>
                                    <th colspan="7">Total Share Purchase Amount</th>
                                    <th class="text-center"> <?= number_format($total_loans) ?> </th>
                                </tr>
                                <tr>
                                    <th colspan="7">Total Share Purchases</th>
