            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="mt-0 header-title">Clients' Loans Search Query </h4>
                    ...
                    mySuccess();
                                ...
                                <form method="post" action="<?= BACKEND_BASE_URL ?>Bank/search_loans_general.php?branch=<?php echo $user[0]['branchId']; ?>&bank=<?php echo $user[0]['bankId']; ?>">
