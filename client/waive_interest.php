...
if (isset($_POST['submit'])) {
    ...
    // var_dump($res);
    // exit;
    $res = $response->waiveInterest($_POST);
    if ($res) {
        setSessionMessage(true, "Loan interest successfully waived");
    } else {
            ...
            <div class="container-fluid">
                <!-- <div class="row page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Interest Waiver</a></li>
                    </ol>
                </div> -->
                <!-- row -->
                <div class="card">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="mt-0 header-title">Interest Waiver Form</h4>
                        <p class="text-muted mb-3"></p>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Interest to waiver</label>
                                        <input id="total_amount" type="text" step="any" value="<?= number_format(@$selected_loan['loan']['interest_due']) ?>" min="0" data-max="<?= @$selected_loan['loan']['interest_balance'] ?>" name="amount" class="form-control comma_separated" placeholder="Interest to waiver" required="">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
