            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="mt-0 header-title">Client Loan Search Query </h4>
                                <p class="text-muted mb-3">Search by Name | Client No | Account No | Phone Number</p>
                                <?php
                    ...
                    mySuccess();
                                ...
                                <form method="post" action="<?= BACKEND_BASE_URL ?>Bank/search_loans_general_2.php?branch=<?php echo $_GET['branch']; ?>&bank=">
