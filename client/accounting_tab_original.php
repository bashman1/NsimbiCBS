                                ...
                                <div class="default-tab">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div id="chart_of_accounts" class="tab-pane fade <?= @$_REQUEST['transactionsFilter'] ? '' : ' show active ' ?>" role="tabpanel">
                                            ...
                                            <?php
                                            $main_accs =    $response->getMainAccounts();
                                            $sub_accs = $response->getSubAccounts2($user[0]['branchId'], $user[0]['bankId']);


                                            if ($main_accs) {
                                                foreach ($main_accs as $row) {

                                                    echo '
                                                    <div class="accordion accordion-primary" id="accordion-' . $row['acc_code'] . '">
                                                    <div class="accordion-item">
                                                        <div class="accordion-header rounded-lg collapsed" >
                                                            <span class="accordion-header-icon"></span>
                                                            <span class="accordion-header-text"><a href="" id="heading' . $row['acc_code'] . '" data-bs-toggle="collapse"
                                                            data-bs-target="#collapse' . $row['acc_code'] . '" aria-controls="collapse' . $row['acc_code'] . '"
                                                            aria-expanded="false" role="button"> ' . $row['acc_name'] . '  | </a>

                                                            <a href="add_sub_account?id=' . $row['acc_code'] . '&name=' . $row['acc_name2'] . '" class="load_via_ajax"><i class="ti-plus"></i> Add</a></span>

                                                         
                                                        </div>
                                                        <div id="collapse' . $row['acc_code'] . '" class="collapse"
                                                            aria-labelledby="heading' . $row['acc_code'] . '"
                                                            data-bs-parent="#accordion-' . $row['acc_code'] . '">
                                                    ...
                                                    if ($sub_accs) {
                                                        echo '
                                                                ...
                                                                <table class="table table-responsive-md">
                                                                    ...
                                                                    <tbody>
                                                                ';
                                                        foreach ($sub_accs as $rown) {

                                                            if ($rown['type'] == $row['acc_name2']) {
														...
														<div class="dropdown-menu dropdown-menu-end" style="margin: 0px;">
															<a class="dropdown-item" href="add_sub_sub_account?id=' . $rown['id'] . '">Add Sub Account</a>
															<a class="dropdown-item" href="view_account_details?id=' . $rown['id'] . '">View Details</a>
                                                            <a class="dropdown-item confirm-action" data-href="trash_account?id=' . $rown['id'] . '">Trash Account</a>
														</div>
													</div>
                                                                    </td>
                                                                    </tr>
