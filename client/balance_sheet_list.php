                                        ...
                                        <div id="fixed" class="tab-pane fade show active" role="tabpanel">
                                            ...
                                            <div class="profile-skills mb-5">
                                                ...
                                                foreach ($branches as $b) {
                                                    echo '
                                                    <a href="report_balance_sheet.php?branch=' . $b['id'] . '&transaction_start_date=&transaction_end_date=" class="btn btn-primary light btn-xs mb-1">' . $b['name'] . '</a>
                                                    ';
                                                }

                                                ?>

                                                <a href="report_balance_sheet.php" class="btn btn-primary light btn-xs mb-1">General</a>
                                            </div>
                                            <!-- </div> -->
                                        </div>
