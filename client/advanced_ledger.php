                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="text-label form-label" for="exampleInputEmail3">Trxn Start
                                            Date *</label>
                                        <input type="date" name="start_date" class="form-control" name="from_date" value="<?= @$_REQUEST['start_date'] ?? null ?>" placeholder="Start Date">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="text-label form-label" for="exampleInputEmail4">Trxn End
                                            Date *</label>
                                        <input type="date" class="form-control" name="end_date" value="<?= @$_REQUEST['end_date'] ?? null ?>" placeholder="End Date">
                                    </div>
                                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">
                            ...
                            Advanced Journal Entries Ledger
                        </h4>
    ...
    ***********************************-->
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                url: '<?= BACKEND_BASE_URL ?>Bank/get_all_bank_transactions_ajes.php?branch=<?= $_REQUEST['branchId'] ?? $user[0]['branchId']; ?>&bank=<?php echo $user[0]['bankId']; ?>&acid=<?= @$_REQUEST['main_acc'] ?>&start_date=<?= @$_REQUEST['start_date'] ?>&end_date=<?= $_REQUEST['end_date'] ?>',
                type: 'GET',
                dataType: 'json',
        ...
        function bindtoDatatable(data) {
            ...
            //     total_ledger += item.actual_amount
            // }
