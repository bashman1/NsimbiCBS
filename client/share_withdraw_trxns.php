                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">
                                    ...
                                    All Share Withdraw Transactions
                                </h4>
    ...
    ***********************************-->
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $.ajax({
                url: '<?= BACKEND_BASE_URL ?>Bank/get_all_share_withdraws.php?bank=<?php echo $user[0]['bankId']; ?>&branch=<?= $user[0]['bankId'] == '' ? $user[0]['branchId'] : '' ?>',
                type: 'GET',
                dataType: 'json',
