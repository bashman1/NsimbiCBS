...
if (isset($_POST['submit'])) {
    ...
    $res = $response->registerAsset($_POST);
    if ($res) {
        setSessionMessage(true, 'Asset Registered Successfully!');
        header('location:accounting_tab.php');
    } else {
        setSessionMessage(false, 'Asset Registration failed');
                          ...
                          ';
                            ...
                            ';
                                        ...
                                        <select name="main_acc" class="form-control " id="journalacc">
                                            ...
                                            if ($sub_accs) {
                                                ...
                                                foreach ($sub_accs as $acc) {
                                                    if ($acc['type'] == 'ASSETS' && $acc['is_main_account']==0) {
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select id="payment_methods" name="pay_method" class="form-control ">
                                            <option value="cash_increase" selected>Debit Cash (Increases)</option>
                                            <option value="cash_decrease" selected>Credit Cash (Decreases)</option>
                                            <option value="cheque_increase" selected>Debit Cheque/Bank (Increases)</option>
                                            <option value="cheque_decrease" selected>Credit Cheque/Bank (Decreases)</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-block" name="submit">Register Asset</button>
