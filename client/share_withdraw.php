...
$title = 'SHARE WITHDRAW';
require_once('includes/head_tag.php');
$response = new Response();

if (isset($_POST['submit'])) {
    // $amount = str_replace(",", "", $_POST['amount']);
    $res = $response->withdrawShares($_POST);
    if ($res) {
        setSessionMessage(true, 'Shares Withdrawn Successfully!');
        header('location:share_withdraw_trxns.php');
        exit;
    } else {
        setSessionMessage(false, 'Something went wrong! Try again to withdraw shares.');
        header('location:share_withdraw.php');
        exit;
    }
}
$member = [];
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="mt-0 header-title">
                                    <a href="javascript:;" class="btn btn-primary light btn-xs mb-1 is-back-btn hide"><i class="fa fa-arrow-left"></i> Back</a> | Shares Withdraw Form
                                </h4>
                          ...
                          ';
                            ...
                            ';
                                            ...
                                            <div class="form-group">
                                                <label for="projectName">Share Amount to Withdraw :</label>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-6">
                                                        ...
                                                        <select id="payment_methods" name="pay_method" class="form-control" required="">
                                                            ...
                                                            <option value="savings">Deposit to Customer's Savings</option>
                                                        </select>
                                                    </div>
                                                    <!--end col-->
                                                </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="text-center">
                                                    ...
                                                    <a href="<?= 'client_profile_page?id=' . $_GET['t']; ?>" class="btn btn-sm btn-primary load_supplement_ajax">View
                                                        Profile</a>
                                                </div>
                                            </div>
                                            <!--end card-body-->
