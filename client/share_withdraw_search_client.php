                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="<?= BACKEND_BASE_URL ?>Bank/share_withdraw_search_client.php?branch=<?php echo $user[0]['branchId']; ?>&bank=<?php echo $user[0]['bankId']; ?>">
