                    ...
                    <div class="card-header">
                        ...
                        ?>
                            <div>
                                ...
                                <a href="export_report.php?exportFile=report_par_ageing&<?= $request_string ?>&orientation=landscape" target="_blank" class="btn btn-primary light btn-xs">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if (number_is_between($days_between_dates, 1, 30)) {
                                                $total_1_30 += @$loan['principal_balance'];
                                            ?>
                                                <?= number_format(@$loan['principal_balance']) ?>
                                            <?php } else { ?>
                                                -
                                            <?php } ?>
                                        ...
                                        <td>
                                            <?php if (number_is_between($days_between_dates, 31, 60)) {
                                                $total_31_60 += @$loan['principal_balance'];
                                            ?>
                                                <?= number_format(@$loan['principal_balance']) ?>
                                            <?php } else { ?>
                                                -
                                        ...
                                        <td>
                                            <?php if (number_is_between($days_between_dates, 61, 90)) {
                                                $total_61_90 += @$loan['principal_balance'];
                                            ?>
                                                <?= number_format(@$loan['principal_balance']) ?>
                                            <?php } else { ?>
                                                -
                                        ...
                                        <td>
                                            <?php if (number_is_between($days_between_dates, 91, 120)) {
                                                $total_91_120 += @$loan['principal_balance'];
                                            ?>
                                                <?= number_format(@$loan['principal_balance']) ?>
                                            <?php } else { ?>
                                                -
                                        ...
                                        <td>
                                            <?php if (number_is_between($days_between_dates, 121, 180)) {
                                                $total_121_180 += @$loan['principal_balance'];
                                            ?>
                                                <?= number_format(@$loan['principal_balance']) ?>
                                            <?php } else { ?>
                                                -
                                        ...
                                        <td>
                                            <?php if ($days_between_dates > 180) {
                                                $total_above_180 += @$loan['principal_balance'];
                                            ?>
                                                <?= number_format(@$loan['principal_balance']) ?>
                                            <?php } else { ?>
                                                -
