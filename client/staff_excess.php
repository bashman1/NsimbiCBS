                            ...
                            <div class="card-body">
                                <div class="default-tab">
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li class="nav-item"><a href="#onetoone" data-bs-toggle="tab" class="nav-link  <?= !in_array(@$_REQUEST['current_tab'], ['onetomany']) ? 'active' : '' ?> ">Staff Excess</a>
                                        </li>
                                    ...
                                    <div class="tab-content">
                                        <div id="products" class="tab-pane fade <?= !in_array(@$_REQUEST['current_tab'], ['onetomany']) ? 'show active' : '' ?>" role="tabpanel">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h4 class="text-primary mb-4">All Staff Excess Cash</h4>
                                                     <?php
                                                    if($permissions->hasPermissions('register_staff_excess')):
                                                    ?>
                                                    <a href="register_excess.php" class="btn btn-primary light btn-xs mb-1">Register Excess</a>
<?php endif; ?>
                                                </div>
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        <table id="example3" class="table table-striped" style="min-width: 845px">
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                $frs = $response->getExcess($user[0]['bankId'], $user[0]['branchId']);
                                                                if ($frs != '') {
                                                                    foreach ($frs as $fr) {
                                                                        echo ' 
        <tr>
