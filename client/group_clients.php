                    ...
                    <div class="card-header">
                        ...
                        <?php if ($permissions->hasSubPermissions('create_client')) { ?>
                            <div class="btn-group" role="group">
                                <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">Add New Group</button>
                                <div class="dropdown-menu" style="margin: 0px;">
                                    <a class="dropdown-item" href="add_group_client.php?1">Member</a>
                                    <a class="dropdown-item" href="add_group_client.php?2">Non-Member</a>
                                </div>
                            </div>
                        <?php } ?>
                    ...
                    dataSrc: function(response) {
                        ...
                        for (let record of data) {
                            ...
                            datatable_data.push({
                                ...
                                'accno': `<a class="text-primary" href='group_client_profile_page.php?id=${encrypt_data(record.userId)}'>${record.actype == '0'?'-':record.membership_no }</a>`,
                                ...
                                'name': `<a class="text-primary" href='group_client_profile_page.php?id=${encrypt_data(record.userId)}'>${record.shared_name}</a> `,
                                    ...
                                    <div class="dropdown custom-dropdown mb-0">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item"
                                                href="group_client_profile_page.php?id=${encrypt_data(record.userId)}"> <i class="fa fa-eye"></i> View Account Profile </a>
                                        </div>
                                    </div>
                                `,
                            })
