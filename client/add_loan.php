...
if (isset($_POST['submit'])) {
    ...
    $res = $response->addLoan($_POST['client'], $_POST['product'], $_POST['disbursedate'], $amount, $_POST['duration'], $_POST['notes'], $user[0]['bankId'], $_POST['branch'], $user[0]['userId'], $_POST['freq']);
    if ($res['success']) {
        if ($st == 2) {
            // redirect manual payment form
            header('location:loan_applications.php?success2');
            exit;
        } else {
                ...
                <div class="row">
                    ...
                    mySuccess();
                          ...
                          <div class="mb-3">
                              ...
                              id="inlineFormCustomSelect" name="branch"
                                            ...
                                            <div id="wizard_confirm" class="tab-pane" role="tabpanel">
                                                ...
                                                <div class="row ">
                                                    <div class="col-lg-12 mb-3">
                                                        <div class="mb-3">
                                                            <button type="submit" id="submit_btn" name="submit" class="btn btn-primary">Create Loan Application</button>
