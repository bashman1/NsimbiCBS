...
if (isset($_POST['submit'])) {
    $_POST['ttype'] = 'TTT';
    $_POST['notes'] =  'TELLER TO TELLER TRANSFER:  ' . $_POST['notes'];
    $res = $response->cashTransfer($_POST);
    if ($res) {

        setSessionMessage(true, 'Cash Transfered successfully!');
        header('location:teller_to_teller.php');
    } else {
                        ...
                        <div class="card">
                          ...
                          ';
                            ...
                            ';
                                        ...
                                        <div class="col-lg-6 mb-2">
                                            <div class="mb-3">
                                                <label class="text-label form-label">Select Teller A/C to receive cash:
                                                    *</label>
                                        ...
                                        <button type="submit" name="submit" class="btn btn-primary">Process Transfer</button>
                                        <!-- </div> -->
