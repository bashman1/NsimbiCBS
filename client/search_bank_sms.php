                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="mt-0 header-title">Institution Search Query </h4>
                                <p class="text-muted mb-3">Search by Name </p>
                               

                                <form method="post" action="<?=BACKEND_BASE_URL?>Bank/bank_search.php">
