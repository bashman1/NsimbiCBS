...
$request_data = ['ReportModel' => 'ClientReport', 'ReportModelMethod' => 'FixedDepositScheduleReport', 'is_client_type' => 0];
                ...
                <div class="card">
                    ...
                    <div class="card-body report-section" id="exreportn">
                        ...
                        <table class="main-header">
                            <tr>
                                <td> <strong> Running Fixed Deposits Report: </strong> </td>
                            </tr>
                        </table>
