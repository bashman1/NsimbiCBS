...
$loans = $response->getAllActiveLoans(@$user[0]['bankId'], @$_REQUEST['branchId'], @$_REQUEST['loan_product_id'], @$_REQUEST['loan_officer_id'], @$_REQUEST['disbursement_start_date'], @$_REQUEST['disbursement_end_date']);
?>
                                            ...
                                            if (@$loans) {
                                                foreach ($loans as $row) {
                                                    ...
                                                    echo '
                                                     ...
                                                     <td>' . date('d-m-Y', strtotime(@$row['date_disbursed'])) . '</td>
