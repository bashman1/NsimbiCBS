	...
	var dlabMorris = function(){
		...
		var donutChart = function(){
			Morris.Donut({
				...
				data: [{
					label: "\xa0 \xa0 Fixed Deposits \xa0 \xa0",
					value: 12,

				}, {
					label: "\xa0 \xa0 Ordinary Deposits \xa0 \xa0",
					value: 30
				}, {
					label: "\xa0 \xa0 Ordinary Withdraws \xa0 \xa0",
					value: 20
				},{
					label: "\xa0 \xa0 Fixed Withdraws \xa0 \xa0",
					value: 20
				}],
				resize: true,
				redraw: true,
				colors: ['#44814E', 'rgb(255, 92, 0)', '#ffaa2b','#ffaa2b'],
				//responsive:true,
				
			});
		}
			var donutChart_mm_wallet = function () {
        Morris.Donut({
          element: "morris_donught_mm_wallet",
          data: [
            {
              label: "\xa0 \xa0 Deposits \xa0 \xa0",
              value: 12,
            },
            {
              label: "\xa0 \xa0 Withdraws \xa0 \xa0",
              value: 30,
            },
            {
              label: "\xa0 \xa0 Transfers \xa0 \xa0",
              value: 20,
            },
          ],
          resize: true,
		...
		var barChart = function(){
			...
			//bar chart
				Morris.Bar({
					...
					ykeys: ['a', 'b', 'c'],
					labels: ['A', 'B', 'C'],
					barColors: ['#44814E', '#ffaa2b', '#ff9f00'],
					hideHover: 'auto',
					gridLineColor: 'transparent',
					resize: true,
					barSizeRatio: 0.25,
		...
		var areaChart = function(){
			...
			Morris.Area({
				...
				lineColors: ['#44814E', 'rgb(16, 202, 147)', 'rgb(255, 92, 0)'],
				xkey: 'period',
				ykeys: ['smartphone', 'windows', 'mac'],
				labels: ['Phone', 'Windows', 'Mac'],
				pointSize: 0,
