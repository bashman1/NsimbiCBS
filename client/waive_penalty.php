...
if (isset($_POST['submit'])) {
    ...
    // var_dump($res);
    // exit;
    $res = $response->waivePenalty($_POST);
    if ($res) {
        setSessionMessage(true, "Loan penalty successfully waived");
    } else {
            ...
            <div class="container-fluid">
                <!-- <div class="row page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Penalty Waiver</a></li>
                    </ol>
                </div> -->
                <!-- row -->
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="met-profile">
                                    <ul class="list-unstyled personal-detail">
                                        <li class="mt-2"><i class="ti-money mr-2 text-info font-22 align-middle"></i>
                                        ...
                                        <li class="mt-2"><i class="ti-check-box mr-2 text-info font-22 align-middle"></i> <b>Product
                                            </b>: <?= @$selected_loan['product']['type_name'] ?></li>
                                        <li class="mt-2"><i class="ti-user mr-2 text-info font-22 align-middle"></i>
                                            <b>Officer </b>:
                                            <?= @$selected_loan['staff']['firstName'] . ' ' . @$selected_loan['staff']['lastName'] . ' - ' . @$selected_loan['staff']['positionTitle'] ?>
                                        </li>

                                        <li class="mt-2"><i class="ti-check-box mr-2 text-info font-22 align-middle"></i> <b>Branch
                                            </b>: <?= @$selected_loan['branch'] ?></li>

                                        <li class="mt-2"><i class="ti-check-box mr-2 text-info font-22 align-middle"></i>
                                            <b>Interest Rate </b>:
                                        ...
                                        <li class="mt-2"><i class="ti-calendar mr-2 text-info font-22 align-middle"></i>
                                ...
                                <div class="btc-price">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <h3 class="mt-0">
                                                <?= number_format(@$selected_loan['loan']['principal_balance'] + @$selected_loan['loan']['interest_balance']) ?>
                                            </h3>
                                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="mt-0 header-title">Penalty Waiver Form</h4>
                        <p class="text-muted mb-3"></p>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Penalty to waiver</label>
                                        <input id="total_amount" type="text" step="any" value="<?= number_format(@$selected_loan['loan']['penalty_balance']) ?>" min="0" max="<?= @$selected_loan['loan']['penalty_balance'] ?>" name="amount" class="form-control comma_separated" placeholder="Penalty to waiver" required data-max="<?= $selected_loan['loan']['penalty_balance'] ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Date of Waiver <i>*</i>: </label>
                                        <input type="date" class="form-control" name="date_of_waiver" value="<?= date('Y-m-d') ?>" placeholder="" required="">
                                    </div>
                                </div>
