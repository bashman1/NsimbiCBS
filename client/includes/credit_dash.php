                                           ...
                                           <div class="row align-items-center">
                                               <div class="col-xl-3 col-xxl-6 col-6">
                                                   <div>
                                                       <div class="d-flex align-items-center mb-3">
                                                           ...
                                                           <div class="ms-3">
                                                               <h4 class="fs-18 font-w700 mb-0">Active Loans</h4>
                                               ...
                                               <div class="col-xl-3 col-xxl-6 col-6">
                                                   <div>
                                                       <div class="d-flex align-items-center mb-3">
                                                           ...
                                                           <div class="ms-3">
                                                               <h4 class="fs-18 font-w700 mb-0">Due Today</h4>
                                               ...
                                               <div class="col-xl-3 col-xxl-6 col-6">
                                                   <div>
                                                       <div class="d-flex align-items-center mb-3">
                                                           ...
                                                           <div class="ms-3">
                                                               <h4 class="fs-18 font-w700 mb-0"> Loans in Arrears</h4>
                                               ...
                                               <div class="col-xl-3 col-xxl-6 col-6">
                                                   <div>
                                                       <div class="d-flex align-items-center mb-3">
                                                           ...
                                                           <div class="ms-3">
                                                               <h4 class="fs-18 font-w700 mb-0">Closed Loans</h4>
                                               ...
                                               <div class="col-xl-3 col-xxl-6 col-6">
                                                   <div>
                                                       <div class="d-flex align-items-center mb-3">
                                                           ...
                                                           <div class="ms-3">
                                                               <h4 class="fs-18 font-w700 mb-0">Declined Loans </h4>
                                               ...
                                               <div class="col-xl-3 col-xxl-6 col-6">
                                                   <div>
                                                       <div class="d-flex align-items-center mb-3">
                                                           ...
                                                           <div class="ms-3">
                                                               <h4 class="fs-18 font-w700 mb-0">Awaiting Disbursement</h4>
                                               ...
                                               <div class="col-xl-3 col-xxl-6 col-6">
                                                   <div>
                                                       <div class="d-flex align-items-center mb-3">
                                                           ...
                                                           <div class="ms-3">
                                                               <h4 class="fs-18 font-w700 mb-0">Loan Applications</h4>
                                               ...
                                               <div class="col-xl-3 col-xxl-6 col-6">
                                                   <div>
                                                       <div class="d-flex align-items-center mb-3">
                                                           <div class="ms-3">
                                                               <span class="fs-14 font-w700"><a href="report_loan_repayments.php" class="btn btn-primary light btn-xs mb-1">View Repayments</a></span>
                                                           </div>
                                                           <div class="ms-3">
                                                               <span class="fs-14 font-w700"><a href="report_loan_status.php" class="btn btn-primary light btn-xs mb-1">View Penalty Accrued</a></span>
                                                           </div>
                                               ...
                                               <div class="col-xl-3 col-xxl-6 col-6">
                                                   <div>
                                                       <div class="d-flex align-items-center mb-3">
                                                           ...
                                                           <div class="ms-3">
                                                               <h4 class="fs-18 font-w700 mb-0">Loan Portifolio</h4>
                                               ...
                                               <div class="col-xl-3 col-xxl-6 col-6">
                                                   <div>
                                                       <div class="d-flex align-items-center mb-3">
                                                           ...
                                                           <div class="ms-3">
                                                               <h4 class="fs-18 font-w700 mb-0">Amount in Arrears</h4>
                                               ...
                                               <div class="col-xl-3 col-xxl-6 col-6">
                                                   <div>
                                                       <div class="d-flex align-items-center mb-3">
                                                           ...
                                                           <div class="ms-3">
                                                               <h4 class="fs-18 font-w700 mb-0">Written-Off Loans</h4>
