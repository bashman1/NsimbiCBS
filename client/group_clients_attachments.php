...
if (isset($_GET['success'])) {
    ...
    $fing2_name = $_GET['fing2_name'];
    $fing3_name = $_GET['fing3_name'];

    $uid = $_GET['uid'];
    $cid = $_GET['cid'];

    $res = $response->setGroupAttachments($uid, $other_name, $pass_name, $sign_name, $fing_name, $fing2_name, $fing3_name);
    // update user to set attachments
    if ($res) {
        setSessionMessage(true, 'Attachments Uploaded Successfully!');
        header('Location: group_clients.php');
    } else {
        setSessionMessage(false, 'Attachments Upload failed! Try again to upload attachments');
        header('Location: group_clients_attachments.php?id=' . $cid);
    }
}

$title = 'GROUP ATTACHMENTS';
                    ...
                    mySuccess();
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" enctype="multipart/form-data" action="https://eaoug.org/group_profile_page.php">
                                    ...
                                    <input type="hidden" name="fing_orig2" value="<?= @$details['fingerprint2']  ?>">
                                    <input type="hidden" name="fing_orig3" value="<?= @$details['fingerprint3']  ?>">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="row ">
                                            <div class="col-lg-12 mb-3">
                                                <div class="mb-3">
                                                    <label class="text-label form-label">Group Photo / Institution Logo</label>
                                            ...
                                            <div class="col-lg-12 mb-3">
                                                <div class="mb-3">
                                                    <label class="text-label form-label">A/C Signatories Scanned
                                                        Signatures Merged</label>
                                            ...
                                            <div class="col-lg-12 mb-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="file" name="fingerprint2" class="form-control" placeholder="">
                                                </div>
                                            </div>
                                            <div class="col-lg-12 mb-3">
                                                <div class="mb-3">
                                                    <label class="text-label form-label">Signatory 3 Fingerprint Biometrics</label>
                                                    <input type="file" name="fingerprint3" class="form-control" placeholder="">
                                                </div>
                                            </div>
