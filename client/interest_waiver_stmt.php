...
$title = 'INTEREST WAIVER REPORT';
require_once('includes/response.php');
require_once('includes/ReportService.php');
$ReportService = new ReportService();
$request_data = ['ReportModel' => 'TransactionReport', 'ReportModelMethod' => 'getInterestWaiverReport', 'is_loan_report' => $_GET['id'] ?? ''];
...
$report_type = "Loan Interest Waiver Report";
